(function($) {
    ...
    $window.on('load', function() {
        window.setTimeout(function() {
            ...
            // Ative o link "Intro" por padrão
            var $nav_a = $nav.find('a');
            $nav_a.removeClass('active'); // Remove a classe 'active' de todos os links
            $('#top-link').addClass('active'); // Adiciona 'active' apenas ao link "Intro"
        }, 100);
    });
